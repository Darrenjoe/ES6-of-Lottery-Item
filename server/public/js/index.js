	...
	var Base = function () {
	  ...
	  _createClass(Base, [{
	    ...
	    value: function assistHandle(e) {
	      ...
	      var $cur = (0, _jquery2.default)(e.currentTarget);
	      var index = $cur.index();
	      (0, _jquery2.default)('.boll-list .byn-boll').removeClass('btn-boll-active');
	      if (index === 0) {
	        (0, _jquery2.default)('.boll-list .byn-boll').addClass('btn-boll-active');
	      }
	      if (index === 1) {
	        (0, _jquery2.default)('.boll-list .byn-boll').each(function (i, t) {
